            ...
            <div className='container h-full pt-40 flex items-center justify-between'>
                <div className='w-1/2 px-20 flex flex-col gap-5'>
                    <div className='flex flex-col gap-1'>
                        <div className='text-[24px]'><span className='font-bold'>уриншуулж</span> хатаасан</div>
                        <div className='text-[64px] font-bold uppercase leading-[70px]'>үхрийн махан борц</div>
                    </div>

                    <div className='font-light text-[20px]'>эрүүл бэлчээрийн, гарал үүсэл тодорхой, эрүүл ахуйн шаардлага хангасан үхрийн махан борц</div>
                    <div className=''>

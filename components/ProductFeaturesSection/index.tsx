            ...
            <div className='container flex flex-col items-center gap-3'>
                ...
                <div className='w-full relative aspect-[16/10] bg-[url("/subtract.png")] bg-no-repeat bg-center bg-bottom'>
                    <div className='absolute bottom-[35%] left-[0%] w-[200px] flex flex-col items-center gap-2 text-center'>
                        ...
                        <p className='text-center px-3'>Хөвсгөл аймгийн Цагаан-Үүр суманд өсгөн бойжуулсан, эрүүл бэлчээрийн үхэр сүрэг</p>
                    </div>
                    {/* health */}
                    <div className='absolute top-[0%] left-[25%] w-[200px] flex flex-col items-center gap-2 text-center'>
                        <div className='relative w-[185px] h-[166px] '>
                            <Image src={'/health-icon.png'} fill alt="health" />
                        </div>
                        <div className='font-bold uppercase text-2xl'>
                            Эрүүл мэндэд тустай
                        </div>
                        <p className='text-center px-3'>Борц нь уламжлалт хүнс төдийгүй эрүүл мэндэд мөн тустай хүнс юм.</p>
                    </div>
                    {/* safety */}
                    <div className='absolute top-[0%] right-[25%] w-[200px] flex flex-col items-center gap-2 text-center'>
                        <div className='relative w-[185px] h-[166px] '>
                            <Image src={'/safety-icon.png'} fill alt="safety" />
                        </div>
                        <div className='font-bold uppercase text-2xl '>
                            Аюулгүй эрүүл хүнс
                        </div>
                    ...
                    <div className='absolute bottom-[35%] right-[0%] w-[200px] flex flex-col items-center gap-2 text-center'>
                        ...
                        <p className='text-center px-3'>Таны ажлыг хөнгөвчилж, үргэлж шинээр нь хүргэх болно.</p>
                    </div>
                </div>
            </div>
        </div>
